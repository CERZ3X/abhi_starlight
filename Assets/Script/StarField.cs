...
public class StarField : MonoBehaviour
{
    ...
    public List<int> ChineseCons;
    public List<int> IndianCons;
    public List<int> GreekCons;
    public List<int> ModenrnCons;
    public List<int> OrionCons;
    public List<int> EgyptianCons;
    ...
    private void LoadStarsGO()
    {
        ...
        {
            GameObject starObject = GameObject.CreatePrimitive(PrimitiveType.Sphere); // earlie quad
    ...
    private void SaveStarsDataAndGOInfo()
    {
        ...
        foreach (StarDataLoader.Star star in stars)
        {
            GameObject starObject = GameObject.CreatePrimitive(PrimitiveType.Sphere); // earlier quad
    ...
    private void SavePlanetsDataAndGOInfo()
    {
        ...
        {
            GameObject planetObject = GameObject.CreatePrimitive(PrimitiveType.Sphere);// earlier quad
    ...
    public void EnableOnlySelectedIndices(int constIndicess)
    {
        EraseAllConstellationLines();
        if (constIndicess == 12) DrawSelectedConstellations(ChineseCons);
        else if (constIndicess == 46) DrawSelectedConstellations(IndianCons);
        else if (constIndicess == 41) DrawSelectedConstellations(GreekCons);
        else if (constIndicess == 48) DrawSelectedConstellations(ModenrnCons);
        else if (constIndicess == 59) DrawSelectedConstellations(OrionCons);
        else if (constIndicess == 70) DrawSelectedConstellations(EgyptianCons);
    ...
    public void Switch2Constellations()
    {
        ...
        else
        {
           // SetupConstellationDisplay(false, selectedConstellationIndices);
            SetupConstellationDisplay(false);
    ...
    private void DrawConstellation(Constellation constellation)
    {
        ...
        for (int i = 0; i < constellation.StarPairs.Length; i += 2)
        {
            ...
            //GameObject extraDetails = new GameObject("ExtraDetails");
            //extraDetails.AddComponent<TextMesh>();
            //extraDetails.GetComponent<TextMesh>().fontSize = 20;
            //extraDetails.GetComponent<TextMesh>().text = "test";
            //extraDetails.transform.parent = constellationParent.transform;
    ...
    void LoadConstellations()
    {
        ...
        foreach (string line in lines)
        {
            ...
            string constellationName = parts[0]+"_"+number.ToString();
